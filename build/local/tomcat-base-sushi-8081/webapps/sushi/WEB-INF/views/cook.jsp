...
<header class="topbar topbar--catalog">
    ...
    <div class="top-meta">
        ...
        <a class="account-photo" href="<%= ctx + "/auth?returnPage=cook&returnRecipeId=" + (recette != null ? recette.getId() : 0) %>" aria-label="<%= currentUser != null ? "Compte " + esc(currentUser.getUsername()) : "Compte" %>">
    ...
    <section class="catalog-panel cook-panel">
        ...
        <div class="cook-player" data-step-player>
            <div class="cook-viewport">
                <article class="cook-slide cook-slide--intro <%= startIndex == 0 ? "is-active" : "" %>" data-step-slide <%= startIndex == 0 ? "" : "hidden" %>>
