...
<header class="topbar topbar--catalog">
    ...
    <div class="top-meta">
        ...
        <a class="account-photo" href="<%= ctx + "/auth?returnPage=cook-steps&returnRecipeId=" + (recette != null ? recette.getId() : 0) %>" aria-label="<%= currentUser != null ? "Compte " + esc(currentUser.getUsername()) : "Compte" %>">
